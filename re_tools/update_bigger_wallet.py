...
def main() -> int:
    parser: argparse.ArgumentParser = argparse.ArgumentParser(description="Update BiggerWallet.h RVAs and constants from Mewgenics byte signatures.")
    parser.add_argument("exe_path", type=Path, help="Path to the updated Mewgenics executable.")
    parser.add_argument("header_path", type=Path, help="Path to BiggerWallet.h.")
    parser.add_argument("--signatures", type=Path, default=Path("bigger_wallet_signatures.json"), help="Path to bigger_wallet_signatures.json.")
